...
class AmazonUtil {
    ...
    public function getIndexValue($attributeId, $label) {
        ...
        if (!$this->options[$attributeId]) {
            ...
            if ($attributeId == 80) {   // 80 is color's id
        ...
        {
            echo "<br> missing attribute $attributeId option: $label" . "<br>";
    ...
    public function createSimpleProduct($Row, $skip=true) {
        ...
        try {
            ...
            echo $product->getId() . ", simple added\n";
        } catch (Exception $e) {
            echo "$name not added\n";
            echo "exception:$e";
        }
    ...
    public function createConfigurableProduct($Row, $skip=true) {
        ...
        try {
            ...
            $productId = $product->getId();
            echo $product->getId() . ", configurable added\n";
        } catch (Exception $e) {
            echo "$name not added\n";
            echo "exception:$e";
        }
