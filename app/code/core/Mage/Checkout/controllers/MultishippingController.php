...
//    }
    ...
    public function createVirtualOrder() {
        ...
        $quote->setCustomerEmail('multishipping@multishipping.com');
        ...
        $addressData = array(
            ...
            'province' => 'guangdong',
            'country_id' => 'CN',
            'multishipping' => $this->_getCheckout()->getOrderIds()
        );
        Mage::log('mutlshipping: ' . $this->_getCheckout()->getOrderIds());
        ...
        $orderIds = $address['multishipping'];
        Mage::log();
    ...
    public function overviewPostAction() {
        ...
        try {
            ...
            Mage::log($paymentInstance->getOrderPlaceRedirectUrl());
