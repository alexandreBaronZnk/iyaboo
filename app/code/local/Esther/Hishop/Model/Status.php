...
class Esther_Hishop_Model_Status extends Varien_Object{
    ...
    {
        return array(
            self::STATUS_ENABLED    => Mage::helper('hishop')->__('Enabled'),
            self::STATUS_DISABLED   => Mage::helper('hishop')->__('Disabled'),
			self::STATUS_HIDDEN		=> Mage::helper('hishop')->__('Hidden')
        );
    }
}
